 ...
 */
public class MinHeapNode<T extends Comparable> {
    ...
    public static void main(String[] arge) {
        MinHeapNode<Integer> heapNode = new MinHeapNode<>();
        heapNode.insert(1);
        heapNode.insert(2);
        heapNode.insert(3);
        heapNode.insert(4);
    ...
    private void sink(Node<T> max) {
        ...
        while (father.left != null) {
            ...
            if (father.right != null) {
                bigSon = less(father.right, bigSon) ? bigSon : father.right;
            }

            if (less(father, bigSon)) {
                exch(father, bigSon);
            }
            father =bigSon;
        }
    ...
    private boolean less(Node<T> node1, Node node2) {
