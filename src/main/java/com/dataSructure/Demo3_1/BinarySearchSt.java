 ...
 */
public class BinarySearchSt<Key extends Comparable, Value> implements OrderedMap<Key, Value> {
    ...
    public static void main(String[] arge) {
        BinarySearchSt<Integer, Integer> binarySearchSt = new BinarySearchSt(100);
        for (int i = 0; i < 10; i++) {
